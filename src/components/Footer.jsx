    ...
    <footer className={`${isDarkMode ? 'bg-[#484148] text-white' : ''}`}>
      <div className=" mx-auto text-center flex justify-center items-center w-3/5 py-28" >
        ...
        <div className="flex flex-col text-left font-playfair w-1/2">
          <a href="https://github.com/hediye-ersan" className={`text-2xl text-[#1769FF] ${isDarkMode ? 'text-[#82BBFF]' : ''}`}>
            {footerData.social.github}
          </a>
          <a href="#" className={`text-2xl text-[#0A0A14] ${isDarkMode ? 'text-[#FFFFFF]' : ''}`}>
            {footerData.social.blog}
          </a>
          <a href="https://www.linkedin.com/in/hediye-ersan-b2799325a/" className={`text-2xl text-[#0077B5] ${isDarkMode ? 'text-[#419CCB]' : ''}`}>
            {footerData.social.linkedin}
          </a>
          <a href="hediyesnl9@gmail.com" className={`text-2xl text-[#AF0C48] ${isDarkMode ? 'text-[#EA2678]' : ''}`}>
