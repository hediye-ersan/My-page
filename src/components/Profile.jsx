...
const Profile = () => {
  ...
  return (
    <section className={`${isDarkMode ? 'text-white bg-[#2A262B]' : 'bg-[#F4F4F4]'}`}>
      <h2 className="text-4xl pt-20 ">{profileData.title}</h2>
      <div className='flex justify-center gap-16 px-32 flex-col sm:flex-row'>
      {/* Basic Information */}
      <div className={`text-left p-[32px] mt-12 sm:mb-16 w-full sm:w-2/5 rounded-xl ${isDarkMode ? 'text-white bg-[#525252]' : 'bg-white '}`}>
